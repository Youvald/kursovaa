...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.new_contract.setGeometry(QtCore.QRect(120, 0, 591, 111))
        font = QtGui.QFont()
        ...
        self.create_contract.setGeometry(QtCore.QRect(410, 300, 220, 72))
        font = QtGui.QFont()
...
"")
        ...
        self.label.setGeometry(QtCore.QRect(190, 110, 451, 161))
        font = QtGui.QFont()
        font.setPointSize(24)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.create_contract_2 = QtWidgets.QPushButton(Dialog)
        self.create_contract_2.setGeometry(QtCore.QRect(180, 300, 220, 72))
        font = QtGui.QFont()
        font.setPointSize(20)
...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.new_contract.setText(_translate("Dialog", "New contract"))
        self.create_contract.setText(_translate("Dialog", "To program"))
        self.label.setText(_translate("Dialog", "<div align=\"center\">You have successfully<br>submitted a request to<br>create a contract!"))
